                    ...
                    <div class="panel-heading">
                        <div class="row">
                            ...
                            <div class="col-xs-6 text-right">
                                <p class="announcement-heading">${requestScope.userSum}</p>
                ...
                <div class="panel panel-warning">
                    <div class="panel-heading">
                        <div class="row">
                            ...
                            <div class="col-xs-6 text-right">
                                <p class="announcement-heading">${requestScope.ordersSum}</p>
                ...
                <div class="panel panel-danger">
                    <div class="panel-heading">
                        <div class="row">
                            ...
                            <div class="col-xs-6 text-right">
                                <p class="announcement-heading">${requestScope.productSum}</p>
                ...
                <div class="panel panel-success">
                    <div class="panel-heading">
                        <div class="row">
                            ...
                            <div class="col-xs-6 text-right">
                                <p class="announcement-heading">${myel:priceTwoDecimal(requestScope.ordersMoney)}</p>

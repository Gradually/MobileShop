            ...
            <div class="col-lg-12">
                <table class="table table-striped table-hover table-condensed table-bordered col-lg-12" align="center" >
                    ...
                    <tr bgcolor="#a9a9a9" align="center">
                        ...
                        <th class="col-lg-1">电话号码(可改)</th>
                        <th class="col-lg-2">通讯地址(可改)</th>
                ...
                <ul class="pagination">
                    <c:choose>
                        <c:when test="${requestScope.pageBean.currentPage != requestScope.pageBean.previousPage}">
                            <li><a href="${pageContext.request.contextPath }/userManager.admin?currentPage=${requestScope.pageBean.previousPage}" >上一页</a></li>
                        </c:when>
                        <c:otherwise>
                    ...
                    <c:choose>
                        <c:when test="${requestScope.pageBean.currentPage != requestScope.pageBean.nextPage}">
                            <li><a href="${pageContext.request.contextPath }/userManager.admin?currentPage=${pageBean.nextPage}" >下一页</a></li>
                        </c:when>
                        <c:otherwise>
...
<script>
    ...
    var freeze = function (uid,state) {
        ...
        if (window.confirm(message)) {
            window.location.href = "${pageContext.request.contextPath}/updateUserInfo.admin?uid=" + uid + "&currentPage=" + ${requestScope.pageBean.currentPage} + "&state=" + state;
        }
    }
</script>

                    ...
                    <c:forEach var="groom" items="${requestScope.radomProductListGroom}">
                        <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                            <div class="product">
                                ...
                                <div class="caption">
                                    <div class="name"><h3><a href="${pageContext.request.contextPath}/product.do?pid=${groom.pid}">${groom.productName}</a></h3></div>
                    ...
                    <c:forEach var="like" items="${requestScope.radomProductListLike}">
                        <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                            <div class="product">
                                ...
                                <div class="caption">
                                    <div class="name"><h3><a href="${pageContext.request.contextPath}/product.do?pid=${like.pid}">${like.productName}</a></h3></div>

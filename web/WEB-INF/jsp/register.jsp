...
<div class="register_form">
    <div class="row">
        <div class="col-md-12 col-xs-12 col-lg-12">
            ...
            <form name="form2" id="form2" method="post" action="${pageContext.request.contextPath}/register" onsubmit="return fromClick()">
                <div class="form-group has-feedback">
                    <div class="input-group">
                        <input type="text" class="form-control required" placeholder="用户名 : 5-10位字母,下划线或数字,首字母必须为字母!!"
                               name="username" value="${sessionScope.form.username}" id="username" required maxlength="10" pattern=[a-zA-z0-9]{5,10}>
                ...
                <div class="form-group has-feedback">
                    <div class="input-group">
                        <input type="email" class="form-control required" placeholder="电子邮箱 : " name="email" id="email"
                               value="${sessionScope.form.email}" required>
                ...
                <div class="form-group has-feedback">
                    <div class="input-group">
                        <input type="text" maxlength="4" pattern="[a-zA-Z0-9]{4}" class="form-control required" placeholder="验证码 : "
                               name="checkCode" id="checkCode"required>
                        <span class="input-group-addon checkcode" role="alert">
                            <img class="" src="${pageContext.request.contextPath}/checkcode" width="120" height="25">
                        </span>
                        <span class="input-group-addon checkcodeHint" role="alert"><span
                                class="glyphicon glyphicon-pencil"></span></span>
                        <%--<div class="input-group-addon checkcode"><img class="" src="${pageContext.request.contextPath}/checkcode" width="100" height="25"></div>--%>
                    </div>
                </div>
